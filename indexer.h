...
void MultiIndexer<Record>::BuildMultiIndex(const string& points_filename,
  ...
  ReadMatrix(&PCA_matrix1, "/sata/ResearchData/BigAnn/pca/pca64_matrix1.dat");
  ReadMatrix(&PCA_matrix2, "/sata/ResearchData/BigAnn/pca/pca64_matrix2.dat");
  ReadMatrix(&ort_matrix1, "/sata/ResearchData/BigAnn/pca/ort16_matrix1.dat");
  ReadMatrix(&ort_matrix2, "/sata/ResearchData/BigAnn/pca/ort16_matrix2.dat");
